...
if($db_found){
    ...
    while ($data = mysqli_fetch_assoc($result)) {
                    ...
                    <input type="hidden" name="idsupp" value="' . $data['id'] . '">
                    
                    <table>
                    <tr>
                    <td colspan="2" align="center"><input type="submit" name="button" value="Supprimer du panier"></td>
                    </tr>
                    </table>
                    </form>';
		...
		echo '
                    ...
                    <table>
                    <tr>
                    <td colspan="2" align="center"><input type="submit" name="button" value="Acheter"></td>
                    </tr>
                    </table>
                    </form>';
